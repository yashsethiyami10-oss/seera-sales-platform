...
describe("Seera Phase 2-5 English and Hindi UI", () => {
  ...
  it("uses identical RBAC before selecting language presentation", () => { const portal = read("app/portal/[portal]/page.tsx"); expect(portal.indexOf("await authorize")).toBeLessThan(portal.indexOf("const experience =")); });
