...
describe("Phase 11 role-aware portal landing",()=>{
  it.each([
    ["system:super_admin","/portal/founder-admin"],["portal:accounts","/portal/accounts"],
  ...
  it("prioritizes founder authority",()=>expect(portalLandingPath(new Set(["portal:accounts","portal:admin"]))).toBe("/portal/founder-admin"));
