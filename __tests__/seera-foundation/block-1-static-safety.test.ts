...
describe("Phase 1 Block 1 static safety", () => {
  ...
  it("has only the eleven explicitly approved Seera migrations in the active path", () => {
    ...
    expect(migrationSql).toHaveLength(11);
