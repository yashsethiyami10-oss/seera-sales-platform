...
describe("Phase 1 Block 1 static safety", () => {
  ...
  it("has only the twelve explicitly approved Seera migrations in the active path", () => {
    ...
    expect(migrationSql).toHaveLength(12);
