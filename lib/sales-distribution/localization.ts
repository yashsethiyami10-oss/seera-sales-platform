...
const EN = {
  ...
  accountsDashboard: "Financial control and reconciliation", paymentVerification: "Payment Verification", ledger: "Ledger", ageing: "Ageing", allocations: "Partial Allocation", expenses: "Expenses & TA Claims",
  invoice: "Invoice", taxInvoice: "Tax Invoice", proForma: "Pro-forma Invoice", receipt: "Receipt", paymentReceipt: "Payment Receipt", deliveryChallan: "Delivery Challan", creditNote: "Credit Note", debitNote: "Debit Note", outstanding: "Outstanding", expense: "Expense", taClaim: "TA Claim", distance: "Distance", partnerSuspended: "Partner Suspended", partnerClosed: "Partner Closed", reactivation: "Reactivation",
...
const HI: Record<keyof typeof EN, string> = {
  ...
  accountsDashboard: "वित्तीय नियंत्रण और मिलान", paymentVerification: "भुगतान सत्यापन", ledger: "खाता-बही", ageing: "बकाया आयु", allocations: "आंशिक आवंटन", expenses: "खर्च और यात्रा भत्ता दावे",
  invoice: "बिल", taxInvoice: "कर चालान", proForma: "प्रो-फॉर्मा चालान", receipt: "रसीद", paymentReceipt: "भुगतान रसीद", deliveryChallan: "डिलीवरी चालान", creditNote: "क्रेडिट नोट", debitNote: "डेबिट नोट", outstanding: "बकाया", expense: "खर्च", taClaim: "यात्रा भत्ता दावा", distance: "दूरी", partnerSuspended: "भागीदार निलंबित", partnerClosed: "भागीदार बंद", reactivation: "पुनः सक्रियकरण",
...
const portalKeys = {
  ...
  accounts: { title: "accountsTitle", dashboard: "accountsDashboard", terminology: "outstanding", navigation: ["paymentVerification", "ledger", "ageing", "allocations", "expenses"] },
} as const;
