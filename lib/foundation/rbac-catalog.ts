...
export const ROLE_PERMISSION_MATRIX: Record<Phase1RoleCode, readonly Phase1Permission[]> = {
  ...
  ACCOUNTS_MANAGER: ["portal:accounts", "settings:view", "billing_profile:manage", "document:create", "document:issue", "document:upload", "document:view_scoped", "document:share", "document:cancel", "finance_dashboard:view", "payment:review", "payment:allocate", "payment_proof:review", "ledger:view", "ledger:post", "ledger:reverse", "credit_extension:approve", "reconciliation:manage", "claim_settlement:manage", "accounting_period:lock", "ta_claim:approve", ...common],
  ACCOUNTS_EXECUTIVE: ["portal:accounts", "document:create", "document:upload", "document:view_scoped", "finance_dashboard:view", "payment:review", "payment:allocate", "payment_proof:review", "ledger:view", "reconciliation:manage", ...common],
