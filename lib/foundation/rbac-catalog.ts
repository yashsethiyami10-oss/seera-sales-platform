...
export const PHASE_1_PERMISSIONS = [
  ...
  "money_desk:view", "money_desk:create", "money_desk:approve", "money_desk:reverse", "money_desk:view_all", "money_desk:cash", "money_desk:bank",
] as const;
