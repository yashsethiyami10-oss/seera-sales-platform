import { authorizeDatabaseCommand, DatabaseIdentityError } from "./identity-guard";
...
export function authorizeTestRuntime(input:{runtimeRole?:string;runtimeDatabaseUrl?:string;configuredProductionUrl?:string;configuredTestUrl?:string}){
  ...
  return authorizeDatabaseCommand({intendedRole:"test",write:true,targetUrl:input.runtimeDatabaseUrl,productionUrl:input.configuredProductionUrl,testUrl:input.configuredTestUrl});
}
