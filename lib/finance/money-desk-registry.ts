...
export const MONEY_DESK_PURPOSES: Record<string, MoneyDeskPurposeDefinition> = {
  "PUR-RM": {
    ...
    requiredFields: ["counterpartyName", "materialId", "quantity", "unit", "locationId", "vendorInvoiceNumber", "invoiceDate", "dueDate", "taxable"],
    optionalFields: ["counterpartyId", "unitCost", "manufactureDate", "expiryDate", "paidNow", "cgst", "sgst", "igst"],
