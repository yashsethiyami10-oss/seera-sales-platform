...
export async function createExpense(
  db: PrismaClient,
  actorId: string,
  input: { date: Date; amount: number; payeeType: string; payeeId?: string; payeeName?: string; categoryId: string; dimensionId?: string; paymentMode: string; treasuryAccountId?: string; gstTreatment?: string; description?: string; documentFileId?: string; isReimbursable?: boolean; employeeId?: string; idempotencyKey: string },
) {
  await authorize(db, { actorId, permission: "expense:create" });
