...
## Phase 0.1 canonical-source correction (2026-08-07)

The `.Codex/docs/MUV_Knowledge/` paths below are obsolete and must not be treated as current.
The verified surviving AI Sutra is
`.claude/docs/MUV_Knowledge/Muv_AI_Sutra_Master_MASTER1.md` (SHA-256
`6722FA08846C84F3845B1D7756CB840434A6672BEB3BC627E3686A151FC10299`). The primary
`.claude/docs/MUV_Knowledge/MUV KNOWLEDGE LIBRARY MASTER.txt` is missing from this checkout and all
local Git refs searched during Phase 0.1. Do not fabricate or substitute it. Follow
`docs/seera/phase-0-1/SEERA_CANONICAL_SOURCE_RESOLUTION.md` for the Founder/source-owner restoration
and validation plan. This correction governs wherever the older path note below conflicts with it.
...
- `.Codex/docs/MUV_Knowledge/MUV KNOWLEDGE LIBRARY MASTER.txt` — *MUV Knowledge Library™ — The
...
- `.Codex/docs/MUV_Knowledge/Muv_AI_Sutra_Master_MASTER1.md` — *Muv AI Sutra™ — The Intelligence
...
**Path note:** these two files physically live under `.Codex/docs/MUV_Knowledge/`, not under a
